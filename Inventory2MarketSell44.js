...
exports.default = {
    ...
    computed: {
        ...
        button_color() {
            console.log('рассчет цвета кнопки',this.price_new.total < ((this.price_best - this.price_best * this.min_sell_limit_warn) >= 0.01 ? this.price_best * this.min_sell_limit_warn : this.price_best - 0.01) ? "grass" : "red");
            
            return this.price_new.total < ((this.price_best - this.price_best * this.min_sell_limit_warn) >= 0.01 ? this.price_best * this.min_sell_limit_warn : this.price_best - 0.01) ? "grass" : "red"
        },
        buttons() {
            return [{
