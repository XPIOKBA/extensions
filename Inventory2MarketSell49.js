...
exports.default = {
    ...
    computed: {
        ...
        button_color() {
            ...
            //     console.log('red');
            //     this.price_new.total && (this.$refs.buttons.style.color="red");
            // } else {
            //     console.log('green');
            //     this.price_new.total && (this.$refs.buttons.style.color="green")
            // }
            window.bb=this.$refs.buttons;
            console.log(this.$refs.buttons);
            
            return this.price_new.total < ((this.price_best - this.price_best * this.min_sell_limit_warn) >= 0.01 ? this.price_best * this.min_sell_limit_warn : this.price_best - 0.01) ? "Внимание демпинг!!!" : "Выставить на продажу"
