...
exports.default = {
    ...
    computed: {
        ...
        last(){
            return JSON.parse(localStorage.lastsellprice)[this.item.thing_prototype_id] ? JSON.parse(localStorage.lastsellprice)[this.item.thing_prototype_id] : 0
        }
    },
    watch: {
        "price_new.total"(e) {
    ...
    methods: {
        ...
        lastpriceset() {
            this.price_new.total = tofloatfix2(this.last);
        },
