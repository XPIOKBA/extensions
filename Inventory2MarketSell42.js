    ...
    computed: {
        ...
        buttons() {
            ...
            return [{
                ...
                color: this.price_new.total < ((this.price_best - this.price_best * this.min_sell_limit_warn) >= 0.01 ? this.price_best * this.min_sell_limit_warn : this.price_best - 0.01) ? "red" : "grass",
                // color: "grass",
                emit: "sell"
            }]
        },
