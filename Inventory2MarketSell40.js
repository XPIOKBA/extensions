...
exports.default = {
    ...
    data: () => ({
        ...
        first: false,
        min_sell_limit: 0.99, // предупреждение.. если демпингуем. кнопка красным.
    ...
    computed: {
        ...
        disableEnter() {
            if (this.price_new.total < ((this.price_best - this.price_best * min_sell_limit) >= 0.01 ? this.price_best * min_sell_limit : this.price_best - 0.01)) {
                this.$refs.buttons.style.color='red';
            } else {
                this.$refs.buttons.style.color='grass';
            }
            return this.price_new.total < ((this.price_best - this.price_best * min_sell_limit) >= 0.01 ? this.price_best * min_sell_limit : this.price_best - 0.01) || this.price_new.total > 15e3
        },
        buttons() {
            return [{
