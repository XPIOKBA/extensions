...
exports.default = {
    ...
    methods: {
        ...
        setprice(p) {
            this.price_new.total = tofloatfix2(p);
        },
        lastpriceset() {
