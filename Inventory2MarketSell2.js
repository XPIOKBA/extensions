...
exports.default = {
    ...
    computed: {
        ...
        buttons() {
            return [{
                is_disabled: this.price_new.total < ((this.price_best-this.price_best*0.99)>=0.01 ? this.price_best*0.99 : this.price_best-0.01) || this.price_new.total > 15e3,
    ...
    methods: {
        ...
        onPriceInput(e, t) {
            const { target: i, data: s } = e;
            if ("string" == typeof s && i.selectionStart === i.selectionEnd) {
                t = String(t),
                    "." === s || "," === s ? (t.includes(".") && e.preventDefault(),
                        "," === s && (document.execCommand("insertText", !1, "."),
                            e.preventDefault())) : !0 !== /\d/.test(s) && e.preventDefault();
